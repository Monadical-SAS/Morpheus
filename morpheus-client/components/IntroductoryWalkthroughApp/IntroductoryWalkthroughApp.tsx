...
import styles from "./IntroductoryWalkthroughApp.module.scss";
...
const IntroductoryWalkthroughApp = () => {
  ...
  useEffect(() => {
    if (user.is_new_user && sectionIndex === 0) {
...
export default IntroductoryWalkthroughApp;

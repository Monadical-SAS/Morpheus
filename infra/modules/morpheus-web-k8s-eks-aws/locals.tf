locals {
  ...
  self_managed_head_iam_role_name = "${var.self_managed_head_iam_role_name}-${random_integer.suffix.result}"
  ...
  scale_up_adv_policy_name       = "morpheus-scale-up-adv-policy-${random_integer.suffix.result}"
  scale_down_policy_name         = "morpheus-scale-down-policy-${random_integer.suffix.result}"
  scale_down_adv_policy_name     = "morpheus-scale-down-adv-policy-${random_integer.suffix.result}"
  scale_up_alarm_name            = "morpheus-scale-up-alarm-${random_integer.suffix.result}"
  scale_up_adv_alarm_name        = "morpheus-scale-up-adv-alarm-${random_integer.suffix.result}"
  scale_down_alarm_name          = "morpheus-scale-down-alarm-${random_integer.suffix.result}"
  scale_down_adv_alarm_name      = "morpheus-scale-down-adv-alarm-${random_integer.suffix.result}"
  db_creds = jsondecode(

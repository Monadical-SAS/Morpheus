...
class RenderConfig:
    ...
    # List of angles to render (override n_views)
...
class GuideConfig:
    ...
    # Viewpoint-dependent prompts
    text_front: Optional[str] = None
    text_side: Optional[str] = None
    text_back: Optional[str] = None
    text_overhead: Optional[str] = None
    text_bottom: Optional[str] = None
    text_not_front: Optional[str] = None

    # Negative viewpoint-dependent prompts
    neg_text: Optional[str] = None
    neg_text_front: Optional[str] = None
    neg_text_side: Optional[str] = None
    neg_text_back: Optional[str] = None
    neg_text_overhead: Optional[str] = None
    neg_text_bottom: Optional[str] = None
    neg_text_not_front: Optional[str] = None
    ...
    # Lora path to load on top of the diffusion model
    diffusion_lora_path: Optional[str] = None
    ...
    background_img: str = 'https://github.com/TEXTurePaper/TEXTurePaper/blob/main/textures/brick_wall.png?raw=true'

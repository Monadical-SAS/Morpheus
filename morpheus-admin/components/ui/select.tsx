...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-sm border border-input border-sm bg-input " +
    ...
    <SelectPrimitive.Content
      ...
      className={cn(
        "relative z-50 min-w-[8rem] overflow-hidden " +
          "rounded-md border border-input border-sm bg-input text-popover-foreground shadow-md " +
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm " +
        "outline-none focus:bg-background2 focus:text-accent-foreground data-[disabled]:pointer-events-none " +

...
class GenerativeAIStableDiffusionCelery(GenerativeAIInterface):
    ...
    def generate_text2img_images(*, request: GenerationRequest) -> str:
        logger.info(
            f"Running Stable Diffusion Text2Img process with request: {request}"
        )
    ...
    def generate_inpainting_images(
        *, request: GenerationRequest, image: Image, mask: Image
        ...
        logger.info(
            f"Running Stable Diffusion Inpainting process with request: {request}"
        )
    ...
    def generate_upscaling_images(*, request: GenerationRequest, image: Image) -> str:
        logger.info(
            f"Running Stable Diffusion Upscaling process with request: {request}"
        )
    ...
    def generate_magic_prompt(*, request: TextGenerationRequest) -> str:
        logger.info(
            f"Running Stable Diffusion MagicPrompt process with request: {request}"
        )
        raise NotImplementedError(
            "Stable Diffusion MagicPrompt is not implemented yet."
        )
